...
export default class MetamaskWriteWallet implements Wallet {
    address: string;
    inGame: boolean = false;

    constructor() {
        this.address = getWindow.ethereum.selectedAddress;
    }
    ...
    async sign(item: UnsignedItemSignature): Promise<SignedSignature> {
    ...
    recover(signature: SignedSignature): string | undefined {
        ...
        const recovered = sigUtil.recoverTypedSignature({
            data: JSON.parse(signature.message),
